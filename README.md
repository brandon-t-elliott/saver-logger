...
- ✅ **RFC 4180 CSV**: Field contents preserved verbatim (commas, quotes, newlines) with spreadsheet formula-injection protection
- ✅ **Plain CSV Output**: Header row plus one line per request
...
The export is plain CSV: a single column-header line followed by one line per
request.
